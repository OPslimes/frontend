    ...
    <div className="grid">
      <div>
        ...
        <h2 className="text-center text-white font-bold mt-7 px-52 mb-4">
          Zeus is a peer-to-peer review website for developers to grade eachother's work. We provide collaboration
          tools for students and new developers to get accurate, peer-reviewed content We utilizes "Code-Spaces" to
          work and edit other people's work. Just send the link to your code space to another person and they can
          edit it whenever!
        </h2>
        <Box translateY={-200}>
